...
import { Users, Calendar, CheckCircle, ArrowRight, ArrowLeft } from 'lucide-react';
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div className="min-w-0">
                    <h1 className="text-lg sm:text-2xl font-extrabold text-slate-800 dark:text-slate-100 flex items-center gap-2 sm:gap-2.5">
                        ...
                        <span className="truncate">연차 일괄 신청</span>
                    </h1>
                    <p className="hidden sm:block text-sm text-slate-400 dark:text-slate-400 mt-1 ml-12">부서 전체 인원에게 특정 기간의 연차를 일괄적으로 등록하고 승인 처리합니다.</p>
                </div>
            </div>
