        ...
        <div className="p-3 sm:p-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white border border-stone-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-stone-100 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-base sm:text-lg font-extrabold text-slate-800">게시글 작성</h1>
                        <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5">{boardMap[boardName] || boardName}에 새 글을 작성합니다</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-5">
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5 sm:mb-2">제목</label>
                        <input
                            type="text"
                            className="w-full border border-stone-200 rounded-xl px-4 py-3 sm:px-5 sm:py-3.5 bg-stone-50 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all text-sm sm:text-[15px] font-bold placeholder:font-normal placeholder:text-slate-400"
                    ...
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5 sm:mb-2">내용</label>
                        <textarea
                            className="w-full border border-stone-200 rounded-xl px-4 py-3 sm:px-5 sm:py-4 h-48 sm:h-72 bg-stone-50 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all resize-none text-sm sm:text-[15px] text-slate-700 leading-relaxed placeholder:text-slate-400"
